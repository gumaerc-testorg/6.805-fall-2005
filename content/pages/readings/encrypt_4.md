...
The Electronic Frontier Foundation's {{% resource_link "fc55c5da-15bf-4905-a653-cbdec0842feb" "Clipper III Archive" %}} contains several statements critical of the proposal.
...
One interesting development was the {{% resource_link "08f5d929-5d03-44c4-9590-c2c72a242226" "demonstration by the Electronic Frontier Foundation" %}} that 56-bit DES could be cracked in 56 hours using a special-purpose machine that can be built at modest cost, thus underlining the inadequacy of 56 bits as a limit on exportable encryption.
...
For an overview of latest events, see the information pages maintained by the {{% resource_link "4f103c8b-668b-45e3-82c0-7c0ab73c237b" "Internet Privacy Coalition" %}} and the {{% resource_link "aac66f87-86a2-4028-b8a1-e81fc3843492" "Center for Democracy and Technology" %}}.